# Contributing to handlebars-helper-create-frame

First and foremost, thank you! We appreciate that you want to contribute to handlebars-helper-create-frame, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for handlebars-helper-create-frame**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for handlebars-helper-create-frame:

- star the [project](https://github.com/jonschlinkert/handlebars-helper-create-frame)
- tweet your support for handlebars-helper-create-frame
...
- **version**: please note the version of handlebars-helper-create-frame are you using
...
[so]: http://stackoverflow.com/questions/tagged/handlebars-helper-create-frame